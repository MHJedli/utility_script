...
install_for_fedora_or_based(){
    ...
    log_message "INFO" "Installing Required Packages"
    printc "YELLOW" "-> Installing Required Packages..."
    sudo dnf install dnf-plugins-core -y || handle_error "Failed to Install Required Packages"
...
log_message "INFO" "Installing Docker for ${DISTRIBUTION_NAME}"
printc "GREEN" "Installing Docker for ${DISTRIBUTION_NAME}..."
